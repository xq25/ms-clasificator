...
public class DatasetController {
    ...
    public ResponseEntity<ApiResponse<DatasetResponseDTO>> findByEvaluationAreaId(@PathVariable Integer evaluationAreaId){
        ApiResponse<DatasetResponseDTO> response = this.datasetService.findByEvaluationAreaId(evaluationAreaId);
    ...
    public ResponseEntity<ApiResponse<DatasetResponseDTO>> update(@PathVariable Integer id, @Valid @RequestBody DatasetUpdateDTO datasetUpdateDTO) {
        ApiResponse<DatasetResponseDTO> response = datasetService.changeMedicalDiagnostic(id, datasetUpdateDTO);
